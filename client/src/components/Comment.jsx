    ...
    return (
        <div className='flex items-center gap-3 mb-2 border-b p-4 dark:border-gray-600 text-sm'>
            <div className='flex-shrink-0'>
                <img className='w-10 h-10 rounded-full bg-gray-200' src={user.profilePicture} alt={user.email} />
            </div>
            <div className='flex-1'>
                <div>
                    <span className='font-bold mr-1 text-xs truncate'>{user ? `@${user.email}` : 'anonymous user'}</span>
